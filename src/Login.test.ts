...
test("Create a user account.", () => {
    ...
    const result: Promise<ISignUpResult> = Login.createAccount("testuser", "SQOg6!egAu7$vtKnr$@0",
        "test@example.com", "Bob", "Smith", "01-01-1111", "+1111111111", "boberts", "boberts",
...
test("Login to a user account.", () => {
    ...
    const result: Promise<CognitoUser> = Login.login("testuser", "SQOg6!egAu7$vtKnr$@0", false);
